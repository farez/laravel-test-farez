<div class="sm:w-3/4">
    <form wire:submit.prevent="createSale">
        ...
        <div class="grid grid-cols-5 gap-4 align-baseline">
            <div>@error('product') <span class="text-red-700">{{ $message }}</span> @enderror</div>
            <div>@error('quantity') <span class="text-red-700">{{ $message }}</span> @enderror</div>
            <div>@error('unitCost') <span class="text-red-700">{{ $message }}</span> @enderror</div>
            <div></div>
            <div></div>
        </div>
    </form>
